...
import { migrateProjectsToSupabase } from '../services/migrationService';

const MigrateProjects: React.FC = () => {
  ...
  const handleMigrate = async () => {
    ...
    try {
      ...
      setMessage('✓ All projects migrated successfully!');
    } catch (error: any) {
  ...
  return (
    <div className="p-8 bg-slate-900 rounded-lg border border-slate-700">
      <h3 className="text-xl font-bold text-white mb-4">Migrate Projects to Supabase</h3>
      <p className="text-slate-400 mb-6">
        This will upload all your existing projects from constants to Supabase.
      </p>
      ...
      >
        {isLoading ? 'Migrating...' : 'Migrate Projects'}
      </button>
